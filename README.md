...
5. Change the settings to your liking. By default the settings in `settings.txt` are set to the "reccomended" defaults. Full explanation of the settings can be found below. (Make sure you toggle the first two frequency settings off if you are reading from an Anki collection)
